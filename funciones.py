...
def reporteTipoSangreES(sangre,matriz):
   crearArchivo("sangre.html",reportePlantillaCorta(sacarDonantesTipoSangre(sangre,sacarDonantesActivos(matriz)),"tipo de sangre"))
   abrirPage("sangre.html")

def reporteRangoEdad(edadIni, edadFin, matriz):
    crearArchivo("rango.html",reportePlantillaCorta(sacarDonantesRangoEdad(edadIni, edadFin, sacarDonantesActivos(matriz)),"rango de edad"))

def reporteTotalES(matriz):
    crearArchivo("total.html",reportePlantillaCorta(sacarDonantesActivos(matriz)))
